...
export function isProUser(): boolean {
  return (
    ...
    isProWidgetEnabled() ||
    // Treat ANY signed-in user as Pro — payments are intentionally disabled
    // while we let new accounts try every feature. Re-introduce the role
    // check below when monetisation is turned back on.
