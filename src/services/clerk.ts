...
// Public Clerk publishable key (safe to ship in client bundles).
// Falls back to a hardcoded value so the published build works even when
// the build environment doesn't surface .env to Vite.
const FALLBACK_PUBLISHABLE_KEY = 'pk_test_d29uZHJvdXMtYmVhci00MS5jbGVyay5hY2NvdW50cy5kZXYk';
const PUBLISHABLE_KEY = ((typeof import.meta !== 'undefined' && import.meta.env?.VITE_CLERK_PUBLISHABLE_KEY) || FALLBACK_PUBLISHABLE_KEY) as string;
