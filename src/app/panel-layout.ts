    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        <div class="header-left">
          ...
          <span class="logo">WORLDCAVE</span><span class="logo-mobile">Worldcave</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
        ...
        <div class="header-right">
          ...
          <span id="aiAssistantMount" class="ai-assistant-mount"></span>
          <span id="proximityMount" class="proximity-mount"></span>
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">WORLDCAVE</span>
        ...
        <div class="mobile-menu-divider"></div>
        <button class="mobile-menu-item" id="mobileMenuSearch">
          <span class="mobile-menu-item-icon">🔍</span>
          <span class="mobile-menu-item-label">${t('header.search')}</span>
        </button>
        <button class="mobile-menu-item" id="mobileMenuAi">
          <span class="mobile-menu-item-icon">🤖</span>
          <span class="mobile-menu-item-label">W.A.V.E. Assistant</span>
        </button>
        <button class="mobile-menu-item" id="mobileMenuFindings">
          <span class="mobile-menu-item-icon">🛰️</span>
          <span class="mobile-menu-item-label">Intel Findings</span>
        </button>
        <button class="mobile-menu-item" id="mobileMenuLayers">
          <span class="mobile-menu-item-icon">🗺️</span>
          <span class="mobile-menu-item-label">Map Layers</span>
        </button>
        <div class="mobile-menu-divider"></div>
