...
export default async function handler(req: Request): Promise<Response> {
  ...
  // unsubscribed.
  try {
    // Premium gating temporarily disabled — all signed-in and anonymous
    // visitors get full WM Analyst access until monetisation is re-enabled.
    await isCallerPremium(req).catch(() => false);
